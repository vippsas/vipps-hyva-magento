<!-- START_METADATA
---
title: Vipps/MobilePay Payment Hyvä Compatibility Module for Adobe Commerce / Magento
sidebar_label: Introduction
sidebar_position: 1
hide_table_of_contents: true
description: Provide Vipps and MobilePay payment options Hyvä compatibility for your Adobe Commerce website.
...
# Payment Hyvä Compatibility module for Adobe Commerce / Magento
...
This module provides Hyvä theme compatibility for the Vipps/MobilePay Payment module, since Hyvä does not use standard Magento templates. It supplies the Hyvä-compatible templates and blocks needed to render the Vipps and MobilePay payment options correctly on Adobe Commerce websites running Hyvä.
...
[https://github.com/vippsas/vipps-hyva-magento/releases](https://github.com/vippsas/vipps-hyva-magento/releases).
...
[Issues](https://github.com/vippsas/vipps-hyva-magento/issues) or email us at [vipps@bluemint.dev](mailto:vipps@bluemint.dev)